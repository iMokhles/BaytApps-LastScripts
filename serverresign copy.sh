...
DEFAULT_ENTITLEMENTS="/Library/Server/Web/Data/Sites/Default/files_store/accounts/scripts_shs/app.entitlements"
DECODER_PATH="/Library/Server/Web/Data/Sites/Default/files_store/accounts/scripts_shs/Tools/mpdecoder"
LOG_FILE="/Library/Server/Web/Data/Sites/Default/files_store/accounts/scripts_shs/AppDistrubtion.log"

SOURCE_ROOT="/Library/Server/Web/Data/Sites/Default/files_store/accounts/scripts_shs"
...
/Library/Server/Web/Data/Sites/Default/files_store/accounts/scripts_shs/icon_generator.sh "$TEMP_PATH/appIcon.png" "$ICONS_TEMP_PATH"
...
#security unlock-keychain -p "asdfg"
...
#/usr/bin/codesign ${VERBOSE} ${KEYCHAIN_FLAG} -f -s "$CertNAME" "$DYLIB"

security unlock-keychain -p asd123 "/Users/administrator/Library/Keychains/login.keychain"
codesign --keychain /Users/administrator/Library/Keychains/login.keychain --force --sign "$CertNAME" "$DYLIB"

#sudo /usr/bin/codesign --force --sign "$EXPANDED_CODE_SIGN_IDENTITY" "$DYLIB"
done
...
#/usr/bin/codesign ${VERBOSE} ${KEYCHAIN_FLAG} -f -s "$CertNAME" "$PLUGIN_EXE"
security unlock-keychain -p asd123 "/Users/administrator/Library/Keychains/login.keychain"
codesign --keychain /Users/administrator/Library/Keychains/login.keychain --force --sign "$CertNAME" "$PLUGIN_EXE"
#
...
security unlock-keychain -p asd123 "/Users/administrator/Library/Keychains/login.keychain"
codesign --keychain /Users/administrator/Library/Keychains/login.keychain --force --sign "$CertNAME" "$PLUGIN_APP_EXE"
fi
done
done
fi
...
security unlock-keychain -p asd123 "/Users/administrator/Library/Keychains/login.keychain"
codesign --keychain /Users/administrator/Library/Keychains/login.keychain --force --sign "$CertNAME" "$FRAMEWORK"
done
fi
...
security unlock-keychain -p asd123 "/Users/administrator/Library/Keychains/login.keychain"
codesign --keychain /Users/administrator/Library/Keychains/login.keychain --force --sign "$CertNAME" --entitlements "$REAL_CODE_SIGN_ENTITLEMENTS" --timestamp=none "$HOOKED_EXE_PATH"
...
OTA_PLIST="/Library/Server/Web/Data/Sites/Default/files_store/accounts/scripts_shs/manifest.plist"
